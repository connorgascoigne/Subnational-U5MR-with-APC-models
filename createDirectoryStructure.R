...
# subfolders for NMR and U5MR APC estimates
if(!dir.exists(paths = paste0(res.dir,'/Age-Period-Cohort/'))){
  dir.create(path = paste0(res.dir,'/Age-Period-Cohort/'))}
if(!dir.exists(paths = paste0(res.dir,'/Age-Period-Cohort/U5MR'))){
  dir.create(path = paste0(res.dir,'/Age-Period-Cohort/U5MR'))}

# subfolders for NMR and U5MR APC estimates
if(!dir.exists(paths = paste0(res.dir,'/Age-Period/'))){
  dir.create(path = paste0(res.dir,'/Age-Period/'))}
if(!dir.exists(paths = paste0(res.dir,'/Age-Period/U5MR'))){
  dir.create(path = paste0(res.dir,'/Age-Period/U5MR'))}
# subfolders for NMR and U5MR APC estimates
if(!dir.exists(paths = paste0(res.dir,'/Age-Cohort/'))){
  dir.create(path = paste0(res.dir,'/Age-Cohort/'))}
if(!dir.exists(paths = paste0(res.dir,'/Age-Cohort/U5MR'))){
  dir.create(path = paste0(res.dir,'/Age-Cohort/U5MR'))}

# subfolders for NMR and U5MR direct estimates
if(!dir.exists(paths = paste0(res.dir,'/SmoothedDirect/'))){
  dir.create(path = paste0(res.dir,'/SmoothedDirect/'))}
if(!dir.exists(paths = paste0(res.dir,'/SmoothedDirect/U5MR'))){
  dir.create(path = paste0(res.dir,'/SmoothedDirect/U5MR'))}
